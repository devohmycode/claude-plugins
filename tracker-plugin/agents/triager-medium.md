---
name: triager-medium
description: tracker:triager at medium reasoning effort — same role and instructions. Launched by the tracker commands when the triager's effort is medium.
