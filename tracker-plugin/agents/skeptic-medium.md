---
name: skeptic-medium
description: tracker:skeptic at medium reasoning effort — same role and instructions. Launched by the tracker commands when the skeptic's effort is medium.
tools: Read, Grep, Glob, Bash, Write
effort: medium
---

<!-- GENERATED from agents/skeptic.md by scripts/generate.mjs — edit the source, then regenerate. -->
