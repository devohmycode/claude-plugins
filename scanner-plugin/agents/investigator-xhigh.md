---
name: investigator-xhigh
description: scanner:investigator at xhigh reasoning effort — same role and instructions. Launched by the scanner commands when the scan type's effort is xhigh.
