---
name: investigator-medium
description: scanner:investigator at medium reasoning effort — same role and instructions. Launched by the scanner commands when the scan type's effort is medium.
