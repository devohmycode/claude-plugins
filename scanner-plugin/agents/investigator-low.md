---
name: investigator-low
description: scanner:investigator at low reasoning effort — same role and instructions. Launched by the scanner commands when the scan type's effort is low.
