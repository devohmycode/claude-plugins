---
name: investigator-max
description: scanner:investigator at max reasoning effort — same role and instructions. Launched by the scanner commands when the scan type's effort is max.
