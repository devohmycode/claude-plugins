---
name: reporter-medium
description: scanner:reporter at medium reasoning effort — same role and instructions. Launched by the scanner commands when the scan type's effort is medium.
