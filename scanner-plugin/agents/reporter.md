---
name: reporter
description: Report phase of a scanner-plugin scan — turns a run's final.json into a self-contained HTML or Markdown report following the profile's report guidance. Launched by /scanner:scan once triage is done.
